			...
			"roles": schema.ListNestedAttribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"signon_policy":               definePermissionAttribute("SignOn Policy", true),
						"routing":                     definePermissionAttribute("Routing Configuration", true),
						"resource_sets":               definePermissionAttribute("Resource Sets", true),
					},
				},
			},
		},
