...
func TestAccCallerIdentityDataSource(t *testing.T) {
    createFile, _ := os.ReadFile("../../tests/caller_identity/data/TestAccCallerIdentityDataSource.tf")
...
func TestAccCallerIdentityDataSource_SecondaryProvider(t *testing.T) {
    createFile, _ := os.ReadFile("../../tests/caller_identity/data/TestAccCallerIdentityDataSource_SecondaryProvider.tf")
