...
// TestMain performs package-level acceptance test setup (including sweeping legacy orphaned resources)
// before executing all unit and acceptance tests in the provider package.
func TestMain(m *testing.M) {
	if os.Getenv("TF_ACC") != "" && testClient != nil {
		sweepLegacyResourceSets()
	}
	os.Exit(m.Run())
}
