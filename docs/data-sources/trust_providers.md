...
- `resource_set_id` (String) ResourceSet unique identifier to filter the Trust Providers, or provider-level override.
...
- `resource_set_id` (String) ResourceSet unique identifier of the Trust Provider.
...
- `oidc_endpoints` (Set of String) The OIDC Endpoints from which Public Keys can be retrieved for verifying the signature of the OIDC ID Token Token.
