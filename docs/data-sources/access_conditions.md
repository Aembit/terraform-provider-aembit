...
- `resource_set_id` (String) ResourceSet unique identifier to filter the Access Conditions, or provider-level override.
...
- `resource_set_id` (String) ResourceSet unique identifier of the Access Condition.
