...
- `lifetime` (Number) Lifetime (in seconds) of the MCP User Based Access Token Credential Provider.
...
- `state` (String) State for the MCP User Based Access Token Credential Provider.
