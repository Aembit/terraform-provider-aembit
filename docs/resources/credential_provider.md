...
- `mcp_ema` (Attributes) MCP Enterprise-Managed Authorization type Credential Provider configuration. (see [below for nested schema](#nestedatt--mcp_ema))
...
<a id="nestedatt--mcp_ema"></a>
### Nested Schema for `mcp_ema`
...
- `mcp_server_url` (String) URL of the MCP Server (e.g., https://mcp.atlassian.com/v1/mcp/authv2 for Atlassian Rovo MCP server).
...
- `is_corporate_idp` (Boolean) Indicates whether this is a corporate Identity Provider. Defaults to `true`.


<a id="nestedatt--mcp_user_based_access_token"></a>
### Nested Schema for `mcp_user_based_access_token`
...
- `callback_url` (String) Authorization Callback URL for the MCP User Based Access Token Credential Provider. Callback URL can be pre-generated by matching the following template; 
...
<a id="nestedatt--mcp_user_based_access_token--custom_parameters"></a>
### Nested Schema for `mcp_user_based_access_token.custom_parameters`

Required:

- `key` (String) Key for Custom Parameter of the MCP User Based Access Token Credential Provider.
- `value` (String) Value for Custom Parameter of the MCP User Based Access Token Credential Provider.

Optional:

- `value_type` (String) Type of value for Custom Parameter of the MCP User Based Access Token Credential Provider. Only `literal` is currently supported.
