...
# CIMD Client Workload Example
resource "aembit_client_workload" "cimd_client" {
    name        = "CIMD Client Workload"
    description = "CIMD Workload with Client-initiated Metadata Document URL"
    is_active   = true
    identities = [
        {
            type  = "cimdClientId"
